...
int main()
{
   ...
   int answer_array[1][50];
   int largest;
   long double answer_final;


   for (j = 0; j < 100; j++){                             // Load answer_array with the sum of each column
//     printf ("j is %d \n", j);
     for (i = 0; i < 12; i++){
//       printf ("i is %d \n", i);
       answer_array[0][i]= answer_array[0][i] + x[j][i];
     }
   }

   for (i = 0; i < 100; i++){                                                 // only requires i<15, but for completness
