//This is task 17 of ProjectEuler, Find the number fo ways to travel across a grid if only moving right and down
...
int main()
{
  ...
  int ones = 0;
      ...
      #pragma omp parallel for private(ones, tens, teens, hundreds, num, current_total) reduction(+: total)
...
// Notes: Cannot seem to get the reduction to work.
